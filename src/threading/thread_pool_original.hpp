...
public:
     ...
     */
    thread_pool_original(const ui32 &_thread_count = std::thread::hardware_concurrency())
...
private:
    ...
    void create_threads()
    {
        ...
        {
            threads[i] = std::thread(&thread_pool_original::worker, this);
        }
    }
